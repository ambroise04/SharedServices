...
namespace SharedServices.DAL.Tests.ServiceGroup
{
    ...
    {
        [TestMethod]
        public void GetByPredicateDiscussion_AddThreeDiscussionWithTwoEmitters_ThenRetrieveDiscussionForAspecificEmitter_ReturnTwoDiscussions()
        {
            ...
            context.SaveChanges();
            //ACT
            var discussions = repository.GetByPredicate(d => d.Emitter.Equals("asdeeeeee2e4efffd2f1df"));
            //ASSERT
